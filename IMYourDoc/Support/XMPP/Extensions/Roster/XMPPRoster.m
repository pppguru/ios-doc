...
- (void)addUser:(XMPPJID *)jid withNickname:(NSString *)optionalName fromStaff:(BOOL )fromStaff

{
    ...
    //
    //    [property addChild:[NSXMLElement elementWithName:@"name" stringValue:@"isStaff"]];
    //
    //    NSXMLElement *value=[NSXMLElement elementWithName:@"value" stringValue:@"TRUE"];
    //
    ...
    //        [groupElement setStringValue:@"Staff"];
    ...
    XMPPPresence *presense=[XMPPPresence presenceWithType:@"subscribe" to:[jid bareJID]];
    
    /*
     
     */
    //    <presence id="UMSks-11" from="physician@imyourdoc.com" type="subscribe"><properties xmlns="http://www.jivesoftware.com/xmlns/xmpp/properties"><property><name>Staff1</name><value type="string">true</value></property></properties></presence>
